    ...
    return (
        <div class="w-full flex items-center justify-center p-6 bg-brand min-h-screen">
            <div class="w-full max-w-3xl animate-in fade-in zoom-in-95 duration-500">
                <div class="mb-8">
                    <h1 class="text-xl font-medium text-white tracking-tight">Edit Item</h1>
                        ...
                        <div class="space-y-5">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500">Optional dimensions for this item.</p>
                                </div>
                                <button
                                    type="button"
                                    onClick={addVariant}
