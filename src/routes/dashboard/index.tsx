                                        ...
                                        <For each={sites()?.destinations ?? []}>
                                            {(site) => (
                                                ...
                                                >
                                                    ...
                                                    <td class="py-5 px-4 text-sm text-zinc-700">
                                                        {site.is_warehouse ? 'Warehouse' : 'Destination'}
                                                    </td>
                                                    <td class="py-5 pr-8 text-right">
                                                        <span class="text-xs font-semibold uppercase text-black">
                                                            {site.is_warehouse ? 'Inventory' : 'Active'}
                                                        </span>
                                                    </td>
                                                </tr>
                                            )}
    ...
    <tr>
        <td colspan={3} class="py-16 text-center">
            <div class="flex flex-col items-center justify-center gap-3">
                ...
                <p class="text-zinc-500 text-sm font-medium">No destinations found</p>
            </div>
        </td>
    </tr>
);
